    ...
    <div className="bg-secondary">
                ...
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      ...
                      result="effect1_dropShadow_1001_743"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect1_dropShadow_1001_743"
                      result="shape"
                    />
                  </filter>
                </defs>
      ...
      <div className="md:mb-[12px] mx-auto py-5 md:px-0 px-5 max-w-[1140px] font-poppins">
        <div className="flex gap-6 md:gap-0 md:items-center md:flex-row  flex-col-reverse justify-between">
          <span className="font-manrope text-white text-[12px]">
            © 2023 Kachem Young Initiative. All rights reserved
          </span>
          <div>
            <ul className="flex flex-row gap-5 font-manrope text-white">
              ...
              <li className="py-4 px-4 flex items-center justify-center rounded-full bg-[#ffffff22]">
                <a href="https://www.linkedin.com/showcase/kachem-young-initiative/
" target="_blank">
              ...
              <li className="py-4 px-5 flex items-center justify-center rounded-full bg-[#ffffff22]">
                <a href=" https://www.instagram.com/kachemyounginitiative/?hl=en" target="_blank">
                <svg
                  width="14"
                  height="14"
                  viewBox="0 0 14 14"
 ...
 */}
              <li className="py-4 px-5 flex items-center justify-center rounded-full bg-[#ffffff22]">
                <a href="https://x.com/Kachemyoungini1?t=TdOtoPIRgXMCPurGZbEAFw&s=09" target="_blank">
                <svg
                  width="12"
                  height="10"
                  viewBox="0 0 12 10"
              ...
              {/* https://www.youtube.com/@kachemyounginitiative1224  */}
              <li className="py-4 px-5 flex items-center justify-center rounded-full bg-[#ffffff22]">
                <a target="_blank" href="https://www.youtube.com/@kachemyounginitiative1224">
                <svg
                  width="14"
                  height="10"
                  viewBox="0 0 14 10"
